...
class MessageNotificationManager:
    ...
    def add_new_message(self, new_message):
        """새로 온 메시지 추가"""
        self.message_notifications.append(new_message.send_message())
...
class KakaoTalkMessage(Message):
    ...
    def send_message(self):
        ...
        message_str += self.content if len(self.content) <= KakaoTalkMessage.notification_message_max_len else self.content[
